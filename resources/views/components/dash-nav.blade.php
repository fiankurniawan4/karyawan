    ...
    <div class="flex flex-col justify-between h-full">
        <div class="flex-grow">
            <div class="px-4 py-6 text-center border-b">
                <h1 class="text-xl font-bold"><span class="text-yellow-700">MyKaryawan</span> Dashboard
                </h1>
            </div>
            <div class="p-4">
                <ul class="space-y-1">
                    <li>
                        <x-nav-link href="/dashboard" :active="request()->is('dashboard')">
                            <svg width="1em" height="1em" fill="currentColor" class="text-lg mr-4"
                                viewBox="0 -56 1136 1136" class="icon" version="1.1"
                    ...
                    <!-- flex items-center bg-yellow-200 rounded-xl font-bold text-sm text-black py-3 px-4 -->
                    <!-- flex bg-white hover:bg-yellow-50 rounded-xl font-bold text-sm text-gray-900 py-3 px-4 -->
                    <li>
                        <x-nav-link href="/dashboard/gaji" :active="request()->is('dashboard/gaji')">
                            <svg width="1em" height="1em" fill="currentColor" class="text-lg mr-4"
                                viewBox="-4.5 0 63 63" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <g id="Group_89" data-name="Group 89" transform="translate(-604 -37)">
                                        <path id="Path_120" data-name="Path 120"
                                            d="M646.509,78.451,605,91V65l40.294-12.182A2.1,2.1,0,0,1,648,54.827V76.442A2.1,2.1,0,0,1,646.509,78.451Z"
                                            fill="#ffc2c2" stroke="#333" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2"></path>
                                        <path id="Path_121" data-name="Path 121" d="M643,85H615V38h28Z" fill="#cbff94"
                                            stroke="#333" stroke-miterlimit="10" stroke-width="2"></path>
                                        <path id="Path_122" data-name="Path 122"
                                            d="M650.171,99H605V65h45.171A3.829,3.829,0,0,1,654,68.829V95.171A3.829,3.829,0,0,1,650.171,99Z"
                                            fill="#ffc2c2" stroke="#333" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2"></path>
                                        <g id="Group_88" data-name="Group 88">
                                            <g id="Group_87" data-name="Group 87">
                                                <line id="Line_132" data-name="Line 132" y2="21"
                                                    transform="translate(629 42)" fill="#ffffff" stroke="#333"
                                                    stroke-miterlimit="10" stroke-width="2"></line>
                                                <g id="Group_86" data-name="Group 86">
                                                    <path id="Path_123" data-name="Path 123"
                                                        d="M629.092,52.5a3.752,3.752,0,1,1,3.875-3.75" fill="none"
                                                        stroke="#333" stroke-miterlimit="10" stroke-width="2"></path>
                                        ...
                                        <path id="Path_125" data-name="Path 125"
                                            d="M657,87H646a5,5,0,0,1-5-5h0a5,5,0,0,1,5-5h11Z" fill="#ffc2c2"
                                            stroke="#333" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2"></path>
                                        <circle id="Ellipse_28" data-name="Ellipse 28" cx="1" cy="1"
                                            r="1" transform="translate(645 81)" fill="#ffffff" stroke="#333"
                    ...
                    <li>
                        <x-nav-link href="/dashboard/karyawan" :active="request()->is('dashboard/karyawan')">
                            <svg width="1em" height="1em" fill="currentColor" class="text-lg mr-4"
                                viewBox="-47.65 0 360.44 360.44" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <defs>
                                    ...
                                    <path class="c"
                                        d="M92.579,86.521a10.449,10.449,0,0,0-11.1-1.724c-3.837,1.7-5.448,5.237-5.842,9.218-.8,8.1,1.63,17.156,6.922,23.417,2.834,3.352,6.921,6.044,11.452,4.99,3.008-.7,1.735-5.328-1.276-4.628-3.153.733-6.22-2.766-7.77-5.089A28.83,28.83,0,0,1,80.7,101.759a28.391,28.391,0,0,1-.393-5.772c.047-1.678.088-3.7,1.069-5.138a5.439,5.439,0,0,1,7.805-.934,2.461,2.461,0,0,0,3.394,0,2.421,2.421,0,0,0,0-3.394Z">
                                    </path>
                                    <path class="c"
                                    ...
                                    <path class="c"
                                        d="M105.705,167.709c1.227,5.036,2.878,9.975,4.528,14.884,2.31,6.868,4.758,13.688,7.247,20.492,5.494,15.017,11.216,29.95,16.977,44.867q3.667,9.5,7.343,18.989a2.469,2.469,0,0,0,2.952,1.676,2.417,2.417,0,0,0,1.676-2.952c-4.868-12.65-9.794-25.278-14.619-37.945-5.578-14.645-11.119-29.317-16.183-44.15-1.929-5.648-3.879-11.333-5.292-17.137-.731-3-5.361-1.73-4.629,1.276Z">
                                    </path>
                                    <path class="c"
                                        d="M175.729,165.766a162.081,162.081,0,0,1-3.863,15.79c-2.049,7.273-4.278,14.494-6.567,21.694q-7.239,22.761-15.234,45.276c-2.011,5.7-4.037,11.4-6.181,17.048a2.419,2.419,0,0,0,1.676,2.952,2.452,2.452,0,0,0,2.952-1.676c4.479-11.805,8.581-23.761,12.642-35.714,5.151-15.161,10.183-30.381,14.618-45.769a177.945,177.945,0,0,0,4.586-18.325,2.469,2.469,0,0,0-1.676-2.952,2.421,2.421,0,0,0-2.953,1.676Z">
                                    </path>
                                    <path class="c"
                                        d="M142.6,267.622a66.352,66.352,0,0,0-4.792,29.46c.807,11.867,1.307,23.75,2.108,35.618q.856,12.68,1.968,25.34a2.464,2.464,0,0,0,2.4,2.4,2.419,2.419,0,0,0,2.4-2.4c-1.236-14.06-2.271-28.145-2.974-42.242-.278-5.573-.587-11.14-.965-16.707a64.2,64.2,0,0,1,.206-14.19,69.879,69.879,0,0,1,4.277-16,2.414,2.414,0,0,0-1.676-2.952,2.459,2.459,0,0,0-2.952,1.676Z">
                                    </path>
                                    <path class="c"
        ...
        <div class="p-4 flex justify-center items-center">
            <a href="/logout"
                class="font-bold flex justify-center items-center text-sm ml-2 w-full bg-yellow-200 rounded-lg px-4 py-4">Logout</a>
        </div>
    </div>
</aside>
<script>
